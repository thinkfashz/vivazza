...
import { ShoppingBag, Gamepad2, Home, Instagram, Building2, List, ChevronRight, Zap, Sparkles, Award, Star, Heart } from 'lucide-react';
...
function App() {
  ...
  return (
    <div className="min-h-screen bg-grain flex flex-col pb-24 md:pb-0 select-none overflow-x-hidden">
      ...
      <main className={`flex-grow max-w-7xl mx-auto w-full px-4 md:px-0 py-0 md:py-8 transition-opacity duration-300 ${isPending ? 'opacity-40 pointer-events-none' : 'opacity-100'}`}>
        <Suspense fallback={<TurboLoader />}>
          {activeSection === 'menu' && (
            <div className="animate-turbo space-y-12 md:space-y-24">
              {/* HERO PREMIUM SECTION */}
              <div className="relative min-h-[50vh] md:min-h-[80vh] w-full flex items-center justify-center overflow-hidden bg-vivazza-stone md:rounded-[3.5rem] shadow-premium group">
              ...
              <section className="py-12 px-4">
                <div className="max-w-7xl mx-auto">
                  <h3 className="font-heading text-4xl md:text-6xl text-vivazza-stone uppercase mb-8 flex items-center gap-3">
                    <Star size={32} className="text-vivazza-gold" fill="currentColor" /> Los Favoritos de Talca
                  </h3>
      ...
      {/* Mobile Navigation - 6 Item Layout for enhanced functionality */}
