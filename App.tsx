          ...
          <div className="space-y-16 md:space-y-24 animate-fade-in-up">
            ...
            <div className="relative rounded-[2.5rem] md:rounded-[3.5rem] overflow-hidden bg-vivazza-stone h-[60vh] md:h-[70vh] flex items-center p-6 md:p-20 shadow-premium">
              <div className="relative z-20 max-w-3xl">
                ...
                <h2 className="font-heading text-6xl md:text-9xl mb-4 md:mb-6 leading-none text-white tracking-tighter uppercase">EL ARTE DE UNA <br/><span className="text-vivazza-red">BUENA PIZZA</span></h2>
                <p className="text-gray-300 text-base md:text-xl font-medium mb-8 md:mb-12 max-w-lg leading-relaxed opacity-90">El equilibrio perfecto entre textura, aroma y sabor.</p>
